...
public class BuyingServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Product product = p1.getProductIdBySupplier(supplier,
                Double.parseDouble(menhGia));
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        ListBuyOfShopDAO l = new ListBuyOfShopDAO();
        List<Product> list1 = l.getAllProduct();
//        for (Product p2 : list1) {
//            if (p2.getSupplier().equals("Mobifone") && p2.getSellPrice() == 20000) {
//                request.setAttribute("p", p2);
//                break;
//            }
//        }
    }
